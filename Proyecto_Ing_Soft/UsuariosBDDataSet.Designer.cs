...
namespace Proyecto_Ing_Soft {
    ...
    public partial class UsuariosBDDataSet : global::System.Data.DataSet {
        ...
        public partial class UsuariosDataTable : global::System.Data.TypedTableBase<UsuariosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public UsuariosRow AddUsuariosRow(int ID_Usuario, string Tipo_Usuario, string Contraseña) {
...
namespace Proyecto_Ing_Soft.UsuariosBDDataSetTableAdapters {
    ...
    public partial class UsuariosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Usuarios] WHERE (([ID_Usuario] = @Original_ID_Usuario) AND ([T" +
                "ipo_Usuario] = @Original_Tipo_Usuario) AND ([Contraseña] = @Original_Contraseña)" +
                ")";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Usuarios] ([ID_Usuario], [Tipo_Usuario], [Contraseña]) VALUES " +
                "(@ID_Usuario, @Tipo_Usuario, @Contraseña);\r\nSELECT ID_Usuario, Tipo_Usuario, Con" +
                "traseña FROM Usuarios WHERE (ID_Usuario = @ID_Usuario)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Usuarios] SET [ID_Usuario] = @ID_Usuario, [Tipo_Usuario] = @Tipo_Usuario, [Contraseña] = @Contraseña WHERE (([ID_Usuario] = @Original_ID_Usuario) AND ([Tipo_Usuario] = @Original_Tipo_Usuario) AND ([Contraseña] = @Original_Contraseña));
SELECT ID_Usuario, Tipo_Usuario, Contraseña FROM Usuarios WHERE (ID_Usuario = @ID_Usuario)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Proyecto_Ing_Soft.Properties.Settings.Default.UsuariosBDConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID_Usuario, Tipo_Usuario, Contraseña FROM dbo.Usuarios";
        ...
        public virtual int Delete(int Original_ID_Usuario, string Original_Tipo_Usuario, string Original_Contraseña) {
        ...
        public virtual int Insert(int ID_Usuario, string Tipo_Usuario, string Contraseña) {
        ...
        public virtual int Update(int ID_Usuario, string Tipo_Usuario, string Contraseña, int Original_ID_Usuario, string Original_Tipo_Usuario, string Original_Contraseña) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Tipo_Usuario, string Contraseña, int Original_ID_Usuario, string Original_Tipo_Usuario, string Original_Contraseña) {
            return this.Update(Original_ID_Usuario, Tipo_Usuario, Contraseña, Original_ID_Usuario, Original_Tipo_Usuario, Original_Contraseña);
        }
    }
